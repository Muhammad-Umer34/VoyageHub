...
const Sidebar = ({ isOpen, setIsOpen }) => {
  ...
  const menuItems = [
    ...
    { icon: Compass, label: 'Countries', path: '/countries', count: 0 },
        ...
        <div className="p-5 border-b border-gray-200 dark:border-gray-800">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div className="flex-1 min-w-0">
              <p className="font-semibold text-gray-900 dark:text-white truncate">{profileData.name}</p>
              <p className="text-sm text-gray-500 dark:text-gray-400 truncate">@{profileData.username}</p>
            </div>
          </div>
          <div className="flex items-center justify-around text-center">
            <div>
              <p className="text-lg font-bold text-gray-900 dark:text-white">{profileData.followers}</p>
              <p className="text-xs text-gray-500">followers</p>
            </div>
            <div>
              <p className="text-lg font-bold text-gray-900 dark:text-white">{profileData.following}</p>
              <p className="text-xs text-gray-500">following</p>
            </div>
            <div>
              <p className="text-lg font-bold text-gray-900 dark:text-white">{profileData.countries}</p>
